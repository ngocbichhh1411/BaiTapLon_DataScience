...
# =========================================================
# 6. MÃ HÓA DỮ LIỆU (TARGET ENCODING)
# =========================================================
...
# --- TẠO MAPPING HÃNG -> DÒNG XE ---
car_mapping = train_temp.groupby('Make')['Model'].unique().apply(list).to_dict()
encoding_dict['car_mapping'] = car_mapping
